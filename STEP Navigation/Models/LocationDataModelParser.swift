    ...
    static func parse(from filename: String, fileType: String, anchorType: AnchorType) throws -> Set<LocationDataModel> {
        ...
        case .busStop:
            ...
            for i in 0...stopsRaw.count-1 {
                ...
                locationModels.insert(LocationDataModel(anchorType: anchorType, anchorCategory: "", coordinates: coordinates, name: stop.Stop_name))
            }
        case .externalDoor:
            ...
            for i in 0...doorsRaw.count-1 {
                ...
                locationModels.insert(LocationDataModel(anchorType: anchorType, anchorCategory: "", coordinates: coordinates, name: name))
            }
        default:
